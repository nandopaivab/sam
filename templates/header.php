...
<div id="wrapper">
    ...
    <aside id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-item <?php echo basename($_SERVER['PHP_SELF']) === 'shopee.php' ? 'active' : ''; ?>">
                <a href="shopee.php" class="sidebar-link">
                    <i class="fa-solid fa-bag-shopping" style="color: #ee4d2d;"></i>
