...
$files = ['index.php', 'crm.php', 'blue_ocean.php', 'baby_niche.php', 'profit_calculator.php', 'audit_logs.php', 'metrify.php', 'shopee.php', 'settings.php', 'erp.php', 'templates/header.php', 'templates/footer.php'];
foreach ($files as $f) {
    $path = __DIR__ . '/' . $f;
    if (file_exists($path)) {
        $size = filesize($path);
